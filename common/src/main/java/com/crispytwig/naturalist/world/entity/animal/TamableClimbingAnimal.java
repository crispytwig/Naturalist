...
import com.crispytwig.naturalist.world.entity.ai.navigation.BetterWallClimberNavigation;
...
public abstract class TamableClimbingAnimal extends TamableAnimal {
    ...
    protected TamableClimbingAnimal(@NotNull EntityType<? extends TamableAnimal> entityType, @NotNull Level level) {
