package com.crispytwig.naturalist.world.entity.animal.ant;
...
public class Ant extends TamableClimbingAnimal implements NeutralMob, Catchable, DataDrivenVariantAnimal {
    ...
    private static final EntityDataAccessor<Long> DATA_ANGER_END_TIME = SynchedEntityData.defineId(Ant.class, EntityDataSerializers.LONG);
    ...
    public void setOwnerUUID(@Nullable UUID owner) {
        this.setOwnerReference(owner == null ? null : EntityReference.of(owner));
    }
    ...
    public void addAdditionalSaveData(@NotNull ValueOutput output) {
        ...
        output.putInt("HillCooldown", this.hillCooldown);
        output.putBoolean("FromHand", this.fromHand());
        output.storeNullable("CarriedFood", UUIDUtil.CODEC, this.carriedFoodId);
    ...
    public void readAdditionalSaveData(@NotNull ValueInput input) {
        ...
        this.hillCooldown = input.getIntOr("HillCooldown", 0);
        this.setFromHand(input.getBooleanOr("FromHand", false));
        this.carriedFoodId = input.read("CarriedFood", UUIDUtil.CODEC).orElse(null);
    ...
    public void loadFromHandTag(@NotNull CompoundTag tag) {
        ...
        Optional<UUID> owner = tag.read("Owner", UUIDUtil.CODEC);
        if (tag.getBooleanOr("Tame", false) && owner.isPresent()) {
            this.setOwnerUUID(owner.get());
