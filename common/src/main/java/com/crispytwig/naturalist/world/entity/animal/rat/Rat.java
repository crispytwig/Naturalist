package com.crispytwig.naturalist.world.entity.animal.rat;
...
import com.crispytwig.naturalist.world.entity.ai.goal.RatHarvestCropsGoal;
...
public class Rat extends TamableClimbingAnimal implements SleepingAnimal, FollowingPet, Catchable, DataDrivenVariantAnimal, ContainerBoundWorker {
    ...
    private static final Predicate<ItemStack> FOOD_ITEMS = stack -> stack.is(NaturalistItemTags.RAT_FOOD);
    ...
    protected void addAdditionalSaveData(@NotNull ValueOutput output) {
        ...
        if (this.workstationPos != null) {
            output.putLong("Workstation", this.workstationPos.asLong());
        }
        this.carriedItems.storeAsItemList(output.list("CarriedItems", ItemStack.CODEC));
    ...
    protected void readAdditionalSaveData(@NotNull ValueInput input) {
        ...
        this.setWorkstation(input.getLong("Workstation").map(BlockPos::of).orElse(null));
        input.list("CarriedItems", ItemStack.CODEC).ifPresent(this.carriedItems::fromItemList);
    ...
    private static class RatBegGoal extends Goal {
        ...
        public boolean canUse() {
            this.player = getServerLevel(this.rat).getNearestPlayer(this.begTargeting, this.rat);
