...
public class Anglerfish extends AbstractFish implements HuntingAnimal, DataDrivenVariantAnimal {
    ...
    public static AttributeSupplier.@NotNull Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 8.0D).add(Attributes.ATTACK_DAMAGE, 2.0D).add(Attributes.MOVEMENT_SPEED, 1.2D);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, WaterAnimal.class, 10, true, false,
                (entity, level) -> this.canHunt() && entity.is(NaturalistEntityTypeTags.ANGLERFISH_HOSTILES)));
    }
