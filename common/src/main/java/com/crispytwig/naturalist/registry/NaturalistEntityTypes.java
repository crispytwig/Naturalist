...
public class NaturalistEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Capybara>> CAPYBARA = register("capybara", EntityType.Builder.of(Capybara::new, MobCategory.CREATURE).sized(0.9F, 0.9F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CarriedFoodEntity>> CARRIED_FOOD = register("carried_food", EntityType.Builder.<CarriedFoodEntity>of(CarriedFoodEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(8));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Hedgehog>> HEDGEHOG = register("hedgehog", EntityType.Builder.of(Hedgehog::new, MobCategory.CREATURE).sized(0.6F, 0.5F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<JungleScorpion>> JUNGLE_SCORPION = register("jungle_scorpion", EntityType.Builder.of(JungleScorpion::new, MobCategory.CREATURE).sized(1.2F, 1.0F).clientTrackingRange(10));
    ...
    private static <T extends Entity> DeferredHolder<EntityType<?>, EntityType<T>> register(String id, EntityType.Builder<T> builder) {
        ResourceKey<EntityType<?>> key = ResourceKey.create(Registries.ENTITY_TYPE, Naturalist.location(id));
